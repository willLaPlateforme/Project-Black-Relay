...
// Forward declaration pour eviter l'inclusion circulaire
class Menu;

class Options {

    public:
        // Prend une reference a Menu pour pouvoir controler la musique
    ...
    private:
        ...
        // Reference au menu pour controler la musique via toggleSound()
        Menu& _menu;
