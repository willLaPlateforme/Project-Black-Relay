...
void Affichage_Menu::_drawNewsPanel() {
    ...
    tag.setPosition({12.f, 616.f}); _window.draw(tag);
    sf::Text alert(_font); alert.setCharacterSize(13);
    alert.setFillColor(sf::Color(220,30,30)); alert.setStyle(sf::Text::Bold);
    alert.setString("ALERTE GLOBALE"); alert.setPosition({16.f, 636.f}); _window.draw(alert);
    ...
    news.setPosition({16.f, 654.f}); _window.draw(news);
}
