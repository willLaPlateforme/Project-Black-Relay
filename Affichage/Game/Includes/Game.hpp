...
private:
    ...
    void _drawTowerMenu(Game& game);
    void _drawWaveTimer(Game& game);
    void _drawPause(Game& game);                     // game passé pour bouton abandonner
    void _drawEndScreen(Game& game, bool victory);   // game passé pour afficher le score
};